...
export function buildStayInvoice(booking, roomType, user) {
  ...
  return {
    ...
    hotel: {
      ...
      address: "No.25 St.Anthoney's road, Eththukala, Negombo, Sri Lanka",
      phone: "+94 31 227 5000",
      email: "reservations@stlachlanhotelnegombo.com",
    },
    booking: {
...
export function buildEventInvoice(booking, user) {
  return {
    ...
    hotel: {
      ...
      address: "No.25 St.Anthoney's road, Eththukala, Negombo, Sri Lanka",
      phone: "+94 31 227 5000",
      email: "info@stlachlanhotelnegombo.com",
    },
    booking: {
...
export function buildDiningInvoice(reservation, order, user) {
  return {
    ...
    hotel: { name: "The Ocean Dining Room", address: "No.25 St.Anthoney's road, Eththukala, Negombo, Sri Lanka", phone: "+94 31 227 5000", email: "reservations@stlachlanhotelnegombo.com" },
    booking: {
