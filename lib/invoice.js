...
export function buildStayInvoice(booking, roomType, user) {
  ...
  return {
    ...
    hotel: {
      ...
      address: "Porutota Road, Ethukala, Negombo, Western Province, Sri Lanka",
...
export function buildDiningInvoice(reservation, order, user) {
  return {
    ...
    hotel: { name: "The Ocean Dining Room", address: "Porutota Road, Ethukala, Negombo, Western Province, Sri Lanka", phone: "+94 31 222 0000", email: "dining@stlachland.lk" },
    booking: {
